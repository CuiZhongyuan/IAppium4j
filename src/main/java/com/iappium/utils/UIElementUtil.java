...
public class UIElementUtil {
     ...
     */
    public static WebElement getElementByKeyword(String pageKeyword, String uiElementKeyword, AndroidDriver driver) {
     ...
     * @param value  选择器值
     */
    public static WebElement getVisibleElement(String by, String value, AndroidDriver driver) {
     ...
     */
    public static WebElement sendInput(String pageKeyword, String uiElementKeyword, AndroidDriver driver, CharSequence... content) {
...
//        inputElement.clear();
     ...
     * @param content 输入
     */
    public static WebElement clickPop(String pageKeyword, String uiElementKeyword, AndroidDriver driver, CharSequence... content) {
        wait = new WebDriverWait(driver, 20);
        try {
     ...
     * @param driver 传入的驱动
     */
    public static WebElement clickButton(String pageKeyword, String uiElementKeyword, AndroidDriver driver) {
        try{
            long time1 = DateUtils.getCurrentMillisecond();
     ...
     * @param driver 传入的驱动
     */
    public static WebElement getElement(String pageKeyword, String uiElementKeyword, AndroidDriver driver) {
        try{
            long time1 = DateUtils.getCurrentMillisecond();
            WebElement buttonElement =getElementByKeyword(pageKeyword,uiElementKeyword,driver);
            log.info("["+uiElementKeyword+"]该点击事件耗时："+(DateUtils.getCurrentMillisecond()-time1)+"ms");
